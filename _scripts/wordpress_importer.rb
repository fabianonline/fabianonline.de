...
module Jekyll
  module WordPress
	...
	TAGS_QUERY = "select tm.term_id,tm.name from wp_fol_term_relationships tr 
				  inner join wp_fol_term_taxonomy tt on tr.term_taxonomy_id = tt.term_taxonomy_id 
				  inner join wp_fol_terms tm on tm.term_id=tt.term_id  
